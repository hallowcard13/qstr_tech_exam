        ...
        <div class="bg-indigo-600 pb-32">
                        ...
                        <div class="flex items-center px-2 lg:px-0">
                            ...
                            <div class="hidden lg:ml-10 lg:block">
                                <div class="flex space-x-4">
                                    ...
                                    <a href="/employees"
                                        class="bg-indigo-700 text-white rounded-md py-2 px-3 text-sm font-medium">Employees</a>
            ...
            <header class="py-10">
                <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <h1 class="text-3xl font-bold tracking-tight text-white">Employees</h1>
                </div>
            </header>
        </div>
